...
A primary goal is to design a develop a \ac{ims} by exploring the application and capabilities of \ac{ai} and \ac{nlp}/\ac{llm} for automating the identification, categorisation, and recommendation of lost items, aiming to reduce manual workload and effectively complete the lost and found cycle of items. % TODO: Ver do LLM
